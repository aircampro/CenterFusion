#
# This center fusion program is taken from here and adapted for realsense color image input :- https://github.com/mrnabati/CenterFusion/blob/master/src/demo.py
#
...
def demo(opt):
  ...
  if opt.demo == 'webcam' or opt.demo == 'realsense' or opt.demo == 'realsensecomb' or \
    opt.demo[opt.demo.rfind('.') + 1:].lower() in video_ext:
	if opt.demo == 'realsense' or opt.demo == 'realsensecomb':
      cam = RealsenseCapture()
      cam.WIDTH = opt.video_w,
      cam.HEIGHT = opt.video_h
      cam.start()
	else:
    ...
    cv2.destroyAllWindows()                                                                   # close view window
  else:
